...
contract WheelsToken is Ownable {
    event Transfer(address indexed from, address indexed to, uint256 value);
    event Approval(
        address indexed owner,
        address indexed spender,
    ...
    function setOtherToken(address otherToken) external onlyOwner {
        ...
        _pairAddress = factory.getPair(address(this), _otherToken);
    }
    ...
    function _swap(address otherToken) internal {
        ...
        _allowances[address(this)][address(uniswapV2Router)] = amount;
        if (
            IERC20(otherToken).allowance(
                address(this),
    ...
    function _mint(address recipient, uint256 amount) internal {
        ...
        _limitWallet = totalSupply.div(100).mul(2);
    ...
    function _transfer(
        ...
        _balances[sender] = _balances[sender].sub(recipientAmount);
        ...
        if (_otherToken != address(0) && pairAmount > 0) {
            _balances[sender] = _balances[sender].sub(pairAmount);
            _balances[address(this)] = _balances[address(this)].add(pairAmount);
            emit Transfer(sender, address(this), pairAmount);
        }
    }
